...
type TabKey = "home" | "apply" | "volunteers" | "contact" | "donation";
...
function PageContentEditorInner() {
    ...
    // Default values for all page content settings
...
Every year our volunteer board of directors along with community members work to make sure every child in Lee County is treated the same — that they too, regardless of income, can have their own gift during the holiday season.`,
    ...
    const handleSaveAll = async () => {
        ...
        try {
            ...
            setSavedMessage("All content saved!");
        ...
        <div className="p-8">
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">Edit content for all public pages</p>
                </div>
            ...
            {activeTab === "apply" && (
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <h2 className="text-lg font-semibold text-gray-900 mb-4">PDF Download Section</h2>
                        <div className="space-y-4">
                            {renderInput("applyPdfTitle", "Section Title")}
                            {renderInput("applyPdfText", "Description", "textarea", 2)}
                        </div>
                    </div>
                </div>
            )}
            ...
            {activeTab === "donation" && (
                <div className="space-y-6">
                    <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                        <h2 className="text-lg font-semibold text-gray-900 mb-4">Donation Form</h2>
                        <div className="space-y-4">
...
export default withConvexProvider(PageContentEditorInner);
